...
## Harvest log 2026-06-12 (Fable — harvest agent)

| lane | branch | merged-SHA | portraits-jpg | thumbs | books | tests | visual-score |
|---|---|---|---:|---:|---:|---:|---:|
| img-pillars | feat/img-pillars | 10f420e | 150 | 150 | — | 1372/4-skipped | 8/10 |
| img-books | feat/img-books | 86b7e28 | — | — | 8 | 1372/4-skipped | 8/10 |

**PNG archive location**:  (untracked, 150 PNGs, ~345MB).
Original lane worktrees still present at  — safe to  when no longer needed.

**Gallery wiring**: PillarManifestClient now walks primary →  → v1-placeholder → empty.
