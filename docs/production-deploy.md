...
# Marketing Funnel — Production Deploy Checklist

> Read this section BEFORE flipping the marketing funnel live. Several of these
> env vars cause `fail-closed` behavior (HTTP 401 / 503) when unset; that
> is a deliberate security posture, not a bug.

## Marketing funnel — required environment variables
...
## Marketing funnel — pre-deploy steps
...
## Marketing funnel — post-deploy smoke
...
## Marketing funnel — known v1 gaps (track in future deploys)
