...
//   2. PLACEHOLDER → /pillar-library-v1-placeholder/manifest.json  (local static)
 ...
 */
export type PillarManifestSource = 'primary' | 'placeholder' | 'empty';
...
export async function fetchManifest(): Promise<Pillar[]> {
    ...
    _inflight = (async (): Promise<Pillar[]> => {
        try {
            ...
            // 2. Local placeholder static asset
            ...
            // 3. Empty (workshop UI surfaces "library unavailable")
            console.warn(
